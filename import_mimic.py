...
#    print(df_)
    ...
    #cont_list          = ['x1']
#     bin_list           =['x0_0.0', 'x0_1.0', 'x0_nan', 'x1_None', 'x1_Spontaneously', 'x1_To Pain', 'x1_To Speech', 'x1_nan', 'x2_Abnormal Flexion',
#                         'x2_Abnormal extension', 'x2_Flex-withdraws', 'x2_Localizes Pain', 'x2_No response', 'x2_Obeys Commands', 'x2_nan',
#                         'x3_10.0', 'x3_11.0', 'x3_12.0', 'x3_13.0', 'x3_14.0', 'x3_15.0','x3_3.0', 'x3_4.0', 'x3_5.0', 'x3_6.0', 'x3_7.0', 'x3_8.0', 'x3_9.0',
#                         'x3_nan', 'x4_Confused', 'x4_Inappropriate Words', 'x4_Incomprehensible sounds', 'x4_No Response', 'x4_No Response-ETT', 'x4_Oriented',
#                          'x4_nan']
#     cont_list           =['Diastolic blood pressure', 'Fraction inspired oxygen', 'Glucose', 'Heart Rate', 'Height', 'Mean blood pressure', 'Oxygen saturation',
#                         'Respiratory rate', 'Systolic blood pressure', 'Temperature', 'Weight', 'pH']
    bin_list           =['Capillary refill rate']
    cont_list           =['Diastolic blood pressure','Fraction inspired oxygen', 'Glascow coma scale eye opening', 'Glascow coma scale motor response',
                     'Glascow coma scale total', 'Glascow coma scale verbal response','Glucose' , 'Heart Rate', 'Height', 'Mean blood pressure',
